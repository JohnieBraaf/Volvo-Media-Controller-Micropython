...
#define MICROPY_HW_UART2_TX  (pin_A2) // LIN TX
#define MICROPY_HW_UART2_RX  (pin_A3) // LIN RX
#define MICROPY_HW_UART3_TX  (pin_B10)
#define MICROPY_HW_UART3_RX  (pin_B11)
#define MICROPY_HW_UART6_TX  (pin_C6) // REPL
#define MICROPY_HW_UART6_RX  (pin_C7) // REPL
#define MICROPY_HW_UART7_TX  (pin_E8) // LIN TX
#define MICROPY_HW_UART7_RX  (pin_E7) // LIN RX
